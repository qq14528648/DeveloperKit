...
public class GridItemDecoration extends BaseItemDecoration {
    ...
    public GridItemDecoration(Context context, int orientation, @DrawableRes int id) {
        super(context, orientation);
        mDivider = ContextCompat.getDrawable(context, id);
    }

//    public GridItemDecoration(Context context, int dividerHeight, int dividerColor, ItemDecorationIndent itemDecorationIndent) {
//        super(context, dividerHeight, dividerColor, itemDecorationIndent);
//    }
//
//    public GridItemDecoration(Context context, int dividerHeight, int dividerColor, List<ItemDecorationIndent> itemDecorationIndent) {
//        super(context, dividerHeight, dividerColor, itemDecorationIndent);
//    }
