...
public class ClearEditText extends AppCompatEditText {
    ...
    //按钮资源
    private final int CLEAR = R.drawable.ic_edit_clear_fill;
    //动画时长
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if (touchable&&isEnabled()&&isUseableClear) {
                setError(null);
                this.setText("");
            }
        }
    ...
    public void setUseableClear(boolean useableClear) {
        isUseableClear = useableClear;
    }
}
